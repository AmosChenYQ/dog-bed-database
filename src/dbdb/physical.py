...
class Storage(object):
    ...
    INTEGER_FORMAT = "!Q" # Q -> unsigned long long, ! network byte order (big endian)
    INTEGER_LENGTH = 8     
    ...
    def _ensure_superblock(self):
        self.lock()
        self._seek_end()
        # Fill the file with 0s to reach SUPERBLOCK_SIZE
    ...
    # only for test used will be deleted after test
